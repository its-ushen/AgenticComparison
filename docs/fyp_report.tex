...
This appendix is organised into six sections.
Appendix~\ref{appendix:calibration} documents judge calibration corrections.
Appendix~\ref{appendix:v1v2} compares Version~1 and Version~2 benchmark results.
Appendix~\ref{appendix:de-tiers} covers capability-gated Tier~D and~E attack classes.
Appendix~\ref{appendix:variance} documents Dual~LLM non-determinism.
Appendix~\ref{appendix:prompts} reproduces all system prompts.
Appendix~\ref{appendix:payloads} provides sample payloads.
...
\subsection*{Pre- and Post-Bugfix Comparison}
...
\subsection*{Spotlighting Validation}
...
\subsection*{Extended Tier Per-Run Results}
...
\paragraph{Plan-Then-Execute: Planner}
...
\paragraph{Plan-Then-Execute: Synthesizer}
...
\paragraph{Dual LLM: Orchestrator}
...
\paragraph{Refund: Destination Redirect}
...
\paragraph{Subscription: Hidden Charges}
...
\paragraph{Invoice: Customer Misdirection}
...
\paragraph{Payment Link: Amount Manipulation}
